...
export default function Sheet({ open, onClose, title, children }) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-end md:items-center justify-center">
      ...
      <div className="animate-sheet relative w-full md:max-w-lg bg-card rounded-t-lg md:rounded-lg border border-line shadow-soft max-h-[88vh] overflow-y-auto overflow-x-hidden">
